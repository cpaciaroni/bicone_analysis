...
#	vpol_power = numpy.empty(num_events1, dtype=float)
#	hpol_power = numpy.empty(num_events1, dtype=float)
#	
...
#        
	...
	Vpower = max(abs(np.asarray(vpol_power)))
	Hpower = max(abs(np.asarray(hpol_power)))
